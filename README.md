...
| Your session ended and nothing warned you | There is no auto-renew by design; a rolling allocation is what OARC objected to. A job ends at its walltime or via `dev-session stop`. Reconnecting books a new one. |
